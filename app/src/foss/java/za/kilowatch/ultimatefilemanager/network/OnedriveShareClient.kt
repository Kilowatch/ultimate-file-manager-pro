...
/**
 * FOSS build stub for OnedriveShareClient.
 *
 * OneDrive is not available in the FOSS build. This stub matches the exact API
 * surface of the real client so all ShareType.ONEDRIVE branches in shared code
 * continue to compile without modification. These branches are unreachable at runtime
 * because the OneDrive option is absent from the AddOnlineStorageActivity FOSS override.
 */
object OnedriveShareClient {

    private fun unsupported(): Nothing =
        throw UnsupportedOperationException("OneDrive is not available in the FOSS build.")
