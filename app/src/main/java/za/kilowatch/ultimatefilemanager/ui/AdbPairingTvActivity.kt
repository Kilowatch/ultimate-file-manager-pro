...
class AdbPairingTvActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_adb_pairing_tv)
        ...
        btnScan.setOnClickListener {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    withContext(Dispatchers.Main) {
                        Toast.makeText(this@AdbPairingTvActivity, R.string.scan_failed_emessage, Toast.LENGTH_SHORT).show()
        ...
        btnTogglePIN.setOnClickListener {
            ...
            btnTogglePIN.text = if (pinVisible) "Hide PIN" else "Use PIN"
        }
            ...
            try {
                val success = withContext(Dispatchers.IO) {
                    try {
                        ...
                        Log.e("AdbPairingTvActivity", "Connection failed: ${e.message}", e)
                        false
                    }
                }
                ...
                if (!connectionSuccess) {
                    ...
                    statusText.setTextColor(ColorblindPalette.statusError(this@AdbPairingTvActivity))
                    statusText.visibility = View.VISIBLE
                    headerStatusText.text = getString(R.string.adb_terminal_status_disconnected)
    ...
    override fun onDestroy() {
        super.onDestroy()
        currentConnectionJob?.cancel()
        // Don't disconnect here — let TerminalActivity manage the connection lifecycle
    }
}
