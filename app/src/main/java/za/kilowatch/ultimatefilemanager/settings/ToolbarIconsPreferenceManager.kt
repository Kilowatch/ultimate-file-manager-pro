...
object ToolbarIconsPreferenceManager {
    ...
    const val KEY_OPEN_WITH = "pref_icon_open_with"
    const val KEY_OPEN_AS = "pref_icon_open_as"
    const val KEY_EXTRACT_SUBTITLES = "pref_icon_extract_subtitles"
    const val KEY_EXTRACT_AUDIO = "pref_icon_extract_audio"
    const val KEY_CONVERT_TO_MP4 = "pref_icon_convert_to_mp4"
    ...
    const val ACTION_OPEN_AS = "open_as"
    const val ACTION_EXTRACT_SUBTITLES = "extract_subtitles"
    const val ACTION_EXTRACT_AUDIO = "extract_audio"
    const val ACTION_CONVERT_TO_MP4 = "convert_to_mp4"
