...
val ALL_BUILTIN_ICONS = intArrayOf(
    ...
    // Apps & Features
    R.drawable.ic_apps, R.drawable.ic_search, R.drawable.ic_analyzer, R.drawable.ic_lock, R.drawable.ic_security_lock,
    ...
    R.drawable.ic_about, R.drawable.ic_support, R.drawable.ic_delete, R.drawable.ic_sort, R.drawable.ic_twin_window, R.drawable.ic_tab_new,
    ...
    R.drawable.ic_exif_cleaner, R.drawable.ic_checksum, R.drawable.ic_music_tag,
