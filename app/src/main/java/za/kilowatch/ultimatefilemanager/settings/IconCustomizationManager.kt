...
val ALL_BUILTIN_ICONS = intArrayOf(
    ...
    R.drawable.ic_remote_enabled, R.drawable.ic_remote_disabled,
    // File Types
    ...
    // Toolbar / Actions
    R.drawable.ic_add, R.drawable.ic_close, R.drawable.ic_edit, R.drawable.ic_refresh,
    R.drawable.ic_save, R.drawable.ic_paste, R.drawable.ic_copy, R.drawable.ic_move,
    R.drawable.ic_rename, R.drawable.ic_share, R.drawable.ic_check, R.drawable.ic_compress,
    R.drawable.ic_compress_image, R.drawable.ic_copy_encrypt, R.drawable.ic_move_encrypt,
    R.drawable.ic_eye, R.drawable.ic_eye_off, R.drawable.ic_undo, R.drawable.ic_duplicate,
