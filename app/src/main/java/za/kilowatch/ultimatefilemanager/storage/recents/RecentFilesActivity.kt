                ...
                if (workInfo != null) {
                    when (workInfo.state) {
                        androidx.work.WorkInfo.State.SUCCEEDED -> {
                            ...
                            Toast.makeText(this@RecentFilesActivity, msg, Toast.LENGTH_LONG).show()
                            refreshData(forceFull = true)
                        }
                        androidx.work.WorkInfo.State.FAILED -> {
                            ...
                            Toast.makeText(this@RecentFilesActivity, err ?: getString(R.string.error_generic), Toast.LENGTH_SHORT).show()
                        }
