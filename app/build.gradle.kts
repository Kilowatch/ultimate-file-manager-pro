...
val appVersionCode = 162          // Mobile versionCode; TV = this + 1
val appVersionName = "1.5.3"      // Shown in Play Store listing
// ─────────────────────────────────────────────────────────────────────────────
...
android {
    ...
    defaultConfig {
        ...
        resourceConfigurations += setOf("en", "ar", "de", "es", "fr", "hi", "id", "in", "ja", "ko", "pt", "ru", "tr")
    }
